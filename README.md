...
- **Opponent Types**: Test your AI against various types of opponents:
  ...
  - - **V1 - Basic**: Uses a basic evaluation of the board, considering both material and position. V1 was benchmarked over 100 games (3 depth) against stockfish level 0 and had an estimated ELO of approximitley 476 - 626. V1 release has the engine in a seperate python file and display to the user what version number is being used. Subsequent versions will have their own enginer version .py files and the user will be able to configure which is used.
